            ...
            schema:
              ...
              properties:
                ...
                policy_id:
                  type: string
                  description: >-
                    ID of the storage policy to use. Leave empty to
                ...
                encryption_supported:
                  ...
                  items:
                    ...
                    examples:
                      - aes-256-ctr
                  description: List of supported encryption ciper of the client.
                  nullable: true
                previous:
                  type: string
                  examples:
                    - c54F3srt
                  description: >-
                    Entity ID of the last known previous version of the file.
                    Only used for updating existing files. Optional ETag check
                    to avoid conflicting version.
                  nullable: true
              x-apifox-orders:
                - uri
                - size
          ...
          content:
            application/json:
              schema:
                type: object
                x-apifox-refs:
                  01JXC5ZK3HG3SDQQMTJHR2REDK: &ref_2
